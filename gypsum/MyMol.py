"""This module contains classes and functions for processing individual
molecules (variants). All variants of the same input molecule are grouped
together in the same MolContainer.MolContainer object. Each MyMol.MyMol is
also associated with conformers described here (3D coordinate sets).

So just to clarify:
MolContainer.MolContainer > MyMol.MyMol > MyMol.MyConformer
"""
