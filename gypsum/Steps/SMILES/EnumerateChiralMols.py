...
def enumerate_chiral_molecules(self):
    ...
    class GetChiral(mp.GeneralTask):
        def value_func(self, items, results_queue):
            ...
            for option in options:
                ...
                if new_mol.crzy_substruc() == False:
                    ...
                    self.results.append(new_mol) #, smi))

    tmp = mp.MultiThreading(params, self.params["num_processors"], GetChiral)

    contnr_indx_no_touch = Utils.contnrs_no_touchd(self, tmp.results)
