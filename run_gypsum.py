...
PARSER = argparse.ArgumentParser(
    ...
    description="""
Gypsum, a free, open-source program for preparing 3D small-molecule models.
Beyond simply assigning atomic coordinates, Gypsum accounts for alternate
...
8. Run Gypsum in multithreading mode, using 4 processors:

python run_gypsum.py --source ./examples/sample_molecules.smi \\
    --job_manager multithreading --num_processors 4

9. Run Gypsum in mpi mode using all available processors:
